...
\bibliography{mmc-Rpackage-biblio}
...
## t = -1.2966, df = 25.077, p-value = 0.2066
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -5.510929  1.252305
## sample estimates:
##   mean of x   mean of y 
## -2.10568525  0.02362672
\end{verbatim}
\begin{alltt}
...
## 
## t = -1.2966, N = 99
## Local Monte Carlo: p-value = 0.24
## Maximized Monte Carlo: p-value = 0.33
\end{verbatim}
\end{kframe}
\end{knitrout}
