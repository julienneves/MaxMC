...
%\VignetteIndexEntry{Maximized Monte Carlo}
%\VignetteEngine{knitr::knitr}
%\VignetteEncoding{UTF-8}

\usepackage{graphicx, float, amssymb, amsmath, titlesec}
\usepackage[citestyle=authoryear, natbib=true]{biblatex}
\addbibresource{mmc_R_biblio.bib}
...
## t = -0.69063, df = 25.615, p-value = 0.496
...
## 
## t = -0.69063, N = 99
## Local Monte Carlo: p-value = 0.71
## Maximized Monte Carlo: p-value = 0.82
\end{verbatim}
\end{kframe}
\end{knitrout}
