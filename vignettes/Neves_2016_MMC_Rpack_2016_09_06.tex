...
\usepackage[citestyle=authoryear, natbib=true, backend=biber]{biblatex}
\addbibresource{Neves_2016_MMC_Rpack.bib}
...
## t = -1.0774, df = 24.651, p-value = 0.2918
...
## 
## t = -1.0774, N = 99
## Local Monte Carlo: p-value = 0.54
## Maximized Monte Carlo: p-value = 0.67
\end{verbatim}
\end{kframe}
\end{knitrout}
